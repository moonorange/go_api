...
import (
	...
	"todo/swagger/restapi/operations"
	"todo/swagger/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../go_api --name TodoList --spec ../swagger.yml --principal interface{}
